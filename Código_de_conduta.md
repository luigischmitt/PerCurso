...
* Submeta apenas materiais que tenham utilidade direta para os estudantes.
* Certifique-se de que os conteúdos enviados sejam claros e organizados.
* Forneça referências ou créditos, sempre que aplicável, para materiais externos utilizados.

Exemplos de comportamentos inaceitáveis incluem:

* Divulgar soluções completas de provas ou atividades avaliativas sem a devida autorização.
* Submeter conteúdo que infrinja direitos autorais ou propriedade intelectual.
* Desrespeitar colaboradores que compartilham conteúdos mesmo em versões preliminares.
...
* Outras condutas que são normalmente consideradas inapropriadas em um ambiente educacional
...
Este Código de Conduta se aplica dentro de todos os espaços do PerCurso e também se aplica quando uma pessoa estiver representando oficialmente o PerCurso em espaços públicos. Exemplos de representação da nossa comunidade incluem usar um endereço de e-mail oficial, postar em contas oficiais de mídias sociais ou atuar como uma pessoa indicada como representante em um evento online ou offline.

## Aplicação

Ocorrências de comportamentos abusivos, de assédio ou que sejam inaceitáveis por qualquer outro motivo poderão ser reportadas para a liderança da comunidade, responsável pela aplicação, via contato *percursoci@gmail.com*. Todas as reclamações serão revisadas e investigadas imediatamente e de maneira justa.
