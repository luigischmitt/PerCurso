...
// Mapeamento de disciplinas para suas pastas de período/optativas no GitHub
const disciplinaPeriodoMap = {
  ...
  'sbc': 'P5',
  'apa': 'P5',
  'paradigmas_linguagens': 'P5',
  'concorrente': 'P5',
  'bd': 'P5',
  'requisitos': 'P5',
  'aprendizagem_maquina': 'P6',
  'seguranca': 'P6',
  'compiladores': 'P6',
  'sistema_distribuidos': 'P6',
  'inovacao': 'P6',
  'metodos_psoft': 'P6',
  'sistemas_informacao': 'P7',
  'ihc': 'P7',
  'engenharia_sistemas': 'P7',
  'gerencimento_psoft': 'P7',
  'teste_software': 'P7',
  'sociedade': 'P8',

  // Optativas CC
  'fund_ihc': 'optativas',
  'teoria_grafos': 'optativas',
  'reuso_software': 'optativas',
  'implementacao': 'optativas',
  'metodos_formais': 'optativas',
  'visualizacao': 'optativas',
  'series': 'optativas',
  'ia_saude': 'optativas',
  'big_data': 'optativas',
  'deep_learn': 'optativas',
  'econ': 'optativas',
  'po': 'optativas',
  'linear_comp': 'optativas',
  'redes_sem_fio': 'optativas',
  'sistemas_informacao_decisao': 'optativas',
  'administracao_sistemas': 'optativas',
  ...
  'lab_lp1': 'P2',
  'lp1': 'P2',
  'circuitos_logicos1': 'P3',
  'eletricidade1': 'P3',
  'fisica_exp': 'P3',
  'calculo3': 'P3',
  'circuitos_logicos2': 'P4',
  'eletricidade2': 'P4',
  'mecanica': 'P4',
  'fisica2': 'P5',
  'series_edo': 'P5',
  ...
  'eletronica1': 'P5',
  'arquitetura': 'P6',
  'arquitetura_avancada': 'P6',
  'eletronica2': 'P7',
  'fluidos': 'P7',
  'microeletronica': 'P7',
  'microcontroladores': 'P7',
  'sinais': 'P8',
  'avaliacao_desempenho': 'P9',
  'cg': 'P9',
  'pdi': 'P9',
  'controle_automacao': 'P9',
  'embarcados1': 'P9',
  'robotica': 'P10',
  'circuitos_integrados': 'P10',
  'teoria_informacao': 'P10',
  'economia': 'P10',
  'adm_eng': 'P10',
  'tcc1': 'P10',
  'tcc2': 'P10',
  'fisica2_opt': 'optativas',
  'arquitetura_avancada_opt': 'optativas',

  // Ciência de Dados e IA
  'intro_cdia': 'P1',
  'intro_computador': 'P1',
  'programacao_estruturada': 'P2',
  'estrutura_dados': 'P3',
  'teorias_probabilidades': 'P3',
  'linear_computacional': 'P3',
  'intro_IA': 'P4',
  'inferencia_estatistica': 'P4',
  'metodos_numericos': 'P4',
  'mineracao_estatistica': 'P6',
  'inteligencia_computacional': 'P6',
  'otimizacao': 'P7',
  'visualizacao_dados': 'optativas',
  'linguagem_natural': 'optativas',
  'sistema_recomendacao': 'optativas',
  'recuperacao_informacao': 'optativas',
  'analise_multivariada': 'optativas',
  'cdia_financas': 'optativas',
  'empreendedorismo': 'optativas',
  'equacoes_diferenciais': 'optativas',
  'gerencia_projetos': 'optativas',
  'iot': 'optativas',
  'metodos_matematicos': 'optativas',
  'otimizacao_nao-linear': 'optativas',
  'pesquisa_aplicada': 'optativas',
};
        ...
        <div className={styles.container}>
          <header className={styles.header}>
            ...
            <div className={styles.buttonsWrapper}>
              <a
                href={`https://github.com/luigischmitt/PerCurso/tree/main/content/${cursoFolder}/${disciplinaPeriodoMap[params.disciplina] || 'P1'}/${params.disciplina}`}
                target="_blank"
