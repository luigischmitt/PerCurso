    ...
    return (
       <div>
         ...
         <section className={styles.buttonsSection}>
           <Link href="/percusos/ciencia-dados-ia/disciplinas-optativas" className={styles.button}>
             DISCIPLINAS OPTATIVAS
           </Link>
           <Link href="/percusos/ciencia-dados-ia/laboratios-e-ligas" className={styles.button}>
